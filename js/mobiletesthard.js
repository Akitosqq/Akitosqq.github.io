const questions = [
	...
	{
		question: "Как вставить комментарий, содержащий более одной строки?  ",
		answers: [
			"!&lt;--This comment has more than one line--&gt;    ",
			"//This comment has more than one line//",
			"//This is a comment  ",
	...
	{
		question: "Каков правильный синтаксис для обращения к внешнему скрипту с именем 'xxx.js'?  ",
		answers: [
			"&lt;script name='xxx.js'&gt;",
			"&lt;script href='xxx.js]&gt;",
			"&lt;script src='xxx.js'&gt;",
	...
	{
		question: "Какой результат будет выражения ниже? null + {0:1}[0] + [,[1],][1][0]",
		answers: [
			"0",
			"1",
			"2",
	...
	{
		question: "Что выведет этот код? let f = function g() { return 23; }; alert( typeof g() );  ",
		answers: [
			"number",
			"undefined",
			"function",
	...
	{
		question: "Какое будет выведено значение? let x = 5; alert( x++ );  ",
		answers: [
			"5",
			"6",
			"Другое",
	...
	{
		question: "Что выведет этот код? alert( 20e-1['toString'](2) );  ",
		answers: [
			"2",
			"10",
			"20",
	...
	},
	{
		question: "Каков правильный синтаксис для обращения к внешнему скрипту с именем 'xxx.js'?  ",
		answers: [
			"<pre><script name='xxx.js'></pre>",
			"<pre><script href='xxx.js]></pre>",
			"<pre><script src='xxx.js'> </pre> ",
			"<pre><script src='xsx.js'> </pre> ",
		],
		correct: 3,
	},
	{
		question: "Как написать ‘Hello World’ в окне оповещения?",
		answers: [
			"msg(‘Hello World’);    ",
			"msgBox(‘Hello World’);",
			"alert(‘Hello World’);    ",
	...
	{
		question: "Как написать оператор IF для выполнения некоторого кода, если 'i' не равно 5?  ",
		answers: [
			"if i <> 5",
			"if i =! 5 then",
			"if (i <> 5)",
	...
	{
		question: "Как запускается цикл FOR?  ",
		answers: [
			"for i = 1 to 5    ",
			"for (i = 0; i <= 5; i++)    ",
			"for (i = 0; i <= 5)",
	...
	{
		question: "Как вы округляете число 7,25 до ближайшего целого числа?  ",
		answers: [
			"rnd(7.25",
			"round(7.25)",
			"Math.round(7.25)",
	...
	{
		question: "Как вы находите число с наибольшим значением x и y?  ",
		answers: [
			"ceil(x, y)",
			"top(x, y)",
			"Math.ceil(x, y)",
	...
	{
		question: "Какое событие происходит, когда пользователь нажимает на HTML-элемент?  ",
		answers: [
			"onclick    ",
			"onmouseover",
			"onmouseover",
